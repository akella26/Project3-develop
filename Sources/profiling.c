/**
 * @file profiling.c
 * @brief This file is to setup the timer used for profiling
 *
 * @author Sowmya
 * @date Aug 2, 2017
 *
...
void TPM_init()
{
	...
	SIM_BASE_PTR->SOPT2 |= SIM_SOPT2_TPMSRC(1);        	//Clock SRC 11- MCGIRCLK, Default clock
	TPM2_BASE_PTR->SC = TPM_SC_PS(6);	 				// Prescalar of 64
